...
export default function UpdateTask(): ReactNode {
	...
	useEffect(() => {
		if (dataController.tasksDataController.includes(id as string)) {
			setTaskTitle(
				dataController.tasksDataController.getTask(id as string).title
			);
			setTaskPriority(
				dataController.tasksDataController.getTask(id as string).priority ??
					"Low"
			);
			setTaskDueDate(
				dataController.tasksDataController
			...
			setTaskCategory(
				dataController.tasksDataController.getTask(id as string).category ??
					"Work"
			);
			setTaskDescription(
				dataController.tasksDataController.getTask(id as string).description
			);
		}
